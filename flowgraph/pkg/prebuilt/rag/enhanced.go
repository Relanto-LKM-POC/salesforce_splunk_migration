...
func NewEnhancedRAGRuntime() *EnhancedRAGRuntime {
	...
	nodeProcessor.RegisterProcessor(graph.NodeType("processor"), ragNodeProcessor)
	nodeProcessor.RegisterProcessor(graph.NodeType("retriever"), ragNodeProcessor)
	nodeProcessor.RegisterProcessor(graph.NodeType("generator"), ragNodeProcessor)

	runtime := flowgraph.NewRuntimeWithNodeProcessor(nodeProcessor)
